...
# Articles in optionally created sections, such as @about@, may be linked to the to the @articles@ page also, and will be displayed then. They will not not counted or displayed as regular articles.
# On install of Textpattern, a dummy article #1 will be automatically installed. Override or delete this article, and also its associated catetories and comment.
