...
# Go to "Presentation › Sections":https://docs.textpattern.com/administration/sections-panel, make sections @categories@, @tag@ and @links@. Then link them to the respective pages @categories@, @tags@ and @links@.
