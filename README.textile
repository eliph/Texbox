...
# Go to "Presentation › Sections":https://docs.textpattern.com/administration/sections-panel, make sections @categories@, @tag@ and @timeline@. Then link them to the respective pages @categories@, @tags@ and @archive@. Also link the @articles@ section to the @articles@ page. Articles in optional sections, such as @about@ may be linked to the to the @articles@ page also, and will be displayed, but are not counted or displayed as regular articles.
