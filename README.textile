...
# Grab the current "release file":https://github.com/eliph/Texbox/releases/, unzip and place the entire @texbox@ folder in the @themes@ folder of your textpattern directory.
